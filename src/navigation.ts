...
export const headerData = {
  links: [
    ...
    {
      text: 'Mnemo',
      href: getPermalink('/category/meaning'),
    },
    {
      text: 'Article',
  ...
  //   },
  // ],
  actions: [{ text: 'Github', href: 'https://github.com/minghao51/curious_chronicles', target: '_blank' }],
};
...
export const footerData = {
  ...
  socialLinks: [
    ...
    { ariaLabel: 'Github', icon: 'tabler:brand-github', href: 'https://github.com/minghao51/curious_chronicles' },
  ],
  footNote: `
